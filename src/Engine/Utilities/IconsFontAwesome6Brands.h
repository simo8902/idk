...
#define ICON_FA_ARROWS_ALT "\uf0b2"       // Arrows pointing outward (Full screen icon)
#define ICON_FA_EXPAND_ARROWS_ALT "\uf31e" // Expand arrows (used for scaling)
#define ICON_FA_SYNC_ALT "\uf021"          // Sync (used for rotation)
